...
| 编码加密 | `icon-code.svg` | 编码/加密工具 | `#818cf8` |
| 主题切换 | `icon-sun-moon.svg` | 浅色/深色模式 | `#a0a0a0` |
...
| PrimeVue | `#4f46e5` | `#ffffff` |
| Pinia | `#F7D336` | `#000000` |
| SM2/SM3/SM4 | `#E60012` | `#ffffff` |
...
| 日期 | 版本 | 变更内容 |
|------|------|----------|
| 2026-07-12 | v1.1 | 新增编码加密相关图标、主题切换图标、技术栈标签色扩展 |
